...
game.gui.addItemMenu('main_menu', game.ELEMENT.TEXT, 'black', 30, 'Dificulty', null, null, {
    click: () => {
...
game.gui.addItemMenu('difficulty_menu', game.ELEMENT.TEXT, 'black', 30, 'EASY', null, null, {
    click: () => {
...
game.gui.addItemMenu('difficulty_menu', game.ELEMENT.TEXT, 'black', 30, 'MEDIUM', null, null, {
    click: () => {
...
game.gui.addItemMenu('difficulty_menu', game.ELEMENT.TEXT, 'black', 30, 'DIFICULT', null, null, {
    click: () => {
        snakeHead.setInfiniteMoveX(false);
        snakeHead.setInfiniteMoveY(false);
        snakeHeadShadow.setInfiniteMoveX(false);
...
game.gui.addItemMenu('difficulty_menu', game.ELEMENT.TEXT, 'black', 30, 'BACK', null, null, {
    click: () => {
